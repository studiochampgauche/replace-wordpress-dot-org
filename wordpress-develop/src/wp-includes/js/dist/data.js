...
const useDispatchWithMap = (dispatchMap, deps) => {
  ...
  const currentDispatchMapRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(dispatchMap);
  (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.useIsomorphicLayoutEffect)(() => {
...
/* harmony export */ });
/* harmony import */ var _wordpress_priority_queue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/priority-queue */ "@wordpress/priority-queue");
/* harmony import */ var _wordpress_priority_queue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_priority_queue__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _async_mode_provider_use_async_mode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../async-mode-provider/use-async-mode */ "./node_modules/@wordpress/data/build-module/components/async-mode-provider/use-async-mode.js");
/**
 * WordPress dependencies
 */
    ...
    function updateValue() {
      ...
      if (true) {
        if (!didWarnUnstableReference) {
          ...
          if (!_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_2___default()(mapResult, secondMapResult)) {
            // eslint-disable-next-line no-console
      ...
      if (!_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_2___default()(lastMapResult, mapResult)) {
...
function useStaticSelect(storeName) {
  return (0,_registry_provider_use_registry__WEBPACK_IMPORTED_MODULE_3__["default"])().select(storeName);
}
function useMappingSelect(suspense, mapSelect, deps) {
  const registry = (0,_registry_provider_use_registry__WEBPACK_IMPORTED_MODULE_3__["default"])();
  const isAsync = (0,_async_mode_provider_use_async_mode__WEBPACK_IMPORTED_MODULE_4__["default"])();
  const store = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => Store(registry, suspense), [registry, suspense]);

  // These are "pass-through" dependencies from the parent hook,
  // and the parent should catch any hook rule violations.
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const selector = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(mapSelect, deps);
  const {
    subscribe,
    getValue
  } = store(selector, isAsync);
  const result = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useSyncExternalStore)(subscribe, getValue, getValue);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useDebugValue)(result);
  return result;
}
...
function useSelect(mapSelect, deps) {
  ...
  const staticSelectModeRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(staticSelectMode);
...
const withDispatch = mapDispatchToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_0__.createHigherOrderComponent)(WrappedComponent => ownProps => {
...
const withRegistry = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_0__.createHigherOrderComponent)(OriginalComponent => props => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_registry_provider__WEBPACK_IMPORTED_MODULE_2__.RegistryConsumer, {
  children: registry => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(OriginalComponent, {
    ...props,
    registry: registry
  })
}), 'withRegistry');
...
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/compose */ "@wordpress/compose");
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _use_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../use-select */ "./node_modules/@wordpress/data/build-module/components/use-select/index.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__);
/**
 * WordPress dependencies
...
const withSelect = mapSelectToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_0__.createHigherOrderComponent)(WrappedComponent => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_0__.pure)(ownProps => {
  const mapSelect = (select, registry) => mapSelectToProps(select, ownProps, registry);
  const mergeProps = (0,_use_select__WEBPACK_IMPORTED_MODULE_2__["default"])(mapSelect);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(WrappedComponent, {
    ...ownProps,
    ...mergeProps
  });
...
const {
  lock,
  unlock
} = (0,_wordpress_private_apis__WEBPACK_IMPORTED_MODULE_0__.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of WordPress.', '@wordpress/data');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   combineReducers: () => (/* reexport safe */ _combine_reducers__WEBPACK_IMPORTED_MODULE_3__.combineReducers),
...
/* harmony import */ var _combine_reducers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./combine-reducers */ "./node_modules/@wordpress/data/build-module/redux-store/combine-reducers.js");
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../controls */ "./node_modules/@wordpress/data/build-module/controls.js");
/* harmony import */ var _lock_unlock__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../lock-unlock */ "./node_modules/@wordpress/data/build-module/lock-unlock.js");
/* harmony import */ var _promise_middleware__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../promise-middleware */ "./node_modules/@wordpress/data/build-module/promise-middleware.js");
...
/* harmony import */ var _thunk_middleware__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./thunk-middleware */ "./node_modules/@wordpress/data/build-module/redux-store/thunk-middleware.js");
/* harmony import */ var _metadata_reducer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./metadata/reducer */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/reducer.js");
/* harmony import */ var _metadata_selectors__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./metadata/selectors */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/selectors.js");
/* harmony import */ var _metadata_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./metadata/actions */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/actions.js");
/**
 * External dependencies
 */
...
function createReduxStore(key, options) {
  ...
  const storeDescriptor = {
    ...
    instantiate: registry => {
      ...
      (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_4__.lock)(store, privateRegistrationFunctions);
      const resolversCache = createResolversCache();
      function bindAction(action) {
        return (...args) => Promise.resolve(store.dispatch(action(...args)));
      }
      const actions = {
        ...mapValues(_metadata_actions__WEBPACK_IMPORTED_MODULE_5__, bindAction),
      ...
      (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_4__.lock)(actions, allActions);
      ...
      const selectors = {
        ...mapValues(_metadata_selectors__WEBPACK_IMPORTED_MODULE_6__, bindMetadataSelector),
      ...
      (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_4__.lock)(selectors, allSelectors);
  ...
  (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_4__.lock)(storeDescriptor, privateRegistrationFunctions);
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  ...
  const enhancedReducer = (0,_combine_reducers__WEBPACK_IMPORTED_MODULE_3__.combineReducers)({
    metadata: _metadata_reducer__WEBPACK_IMPORTED_MODULE_12__["default"],
    root: reducer
  });
  return (0,redux__WEBPACK_IMPORTED_MODULE_11__.createStore)(enhancedReducer, {
    root: initialState
  }, (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.compose)(enhancers));
}
...
function mapSelectorWithResolver(selector, selectorName, resolver, store, resolversCache) {
  function fulfillSelector(args) {
    ...
    if (_metadata_selectors__WEBPACK_IMPORTED_MODULE_6__.hasStartedResolution(metadata, selectorName, args)) {
      return;
    }
    resolversCache.markAsRunning(selectorName, args);
    setTimeout(async () => {
      resolversCache.clear(selectorName, args);
      store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_5__.startResolution(selectorName, args));
      try {
        const action = resolver.fulfill(...args);
        if (action) {
          await store.dispatch(action);
        }
        store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_5__.finishResolution(selectorName, args));
      } catch (error) {
        store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_5__.failResolution(selectorName, args, error));
      }
    }, 0);
  }
...
function getIsResolving(state, selectorName, args) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_0___default()('wp.data.select( store ).getIsResolving', {
    since: '6.6',
    version: '6.8',
...
/* harmony import */ var _utils_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/emitter */ "./node_modules/@wordpress/data/build-module/utils/emitter.js");
...
function createRegistry(storeConfigs = {}, parent = null) {
  const stores = {};
  const emitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_1__.createEmitter)();
  ...
  function registerStoreInstance(name, createStore) {
    ...
    // pending listeners.
    store.emitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_1__.createEmitter)();
    ...
    if (parent) {
      try {
        (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(store.store).registerPrivateActions((0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(parent).privateActionsOf(name));
        (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(store.store).registerPrivateSelectors((0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(parent).privateSelectorsOf(name));
      } catch (e) {
  ...
  function registerGenericStore(name, store) {
    _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_0___default()('wp.data.registerGenericStore', {
      since: '5.9',
  ...
  (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.lock)(registryWithPlugins, {
    privateActionsOf: name => {
      try {
        return (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(stores[name].store).privateActions;
      } catch (e) {
    ...
    privateSelectorsOf: name => {
      try {
        return (0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.unlock)(stores[name].store).privateSelectors;
      } catch (e) {
        return {};
      }
    }
