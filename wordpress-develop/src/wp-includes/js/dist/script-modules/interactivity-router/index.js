...
/* harmony export */   fetchHeadAssets: () => (/* binding */ fetchHeadAssets),
...
/* harmony import */ var _head__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./head */ "./node_modules/@wordpress/interactivity-router/build-module/head.js");
...
function a11ySpeak(messageKey) {
  ...
  Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! @wordpress/a11y */ "@wordpress/a11y")).then(({
    speak
  }) => speak(message),
